...
![Сторінка входу](app/Screenshots/1.png)
...
![Реєстрація](app/Screenshots/2.png)
...
![Список нотаток USER](app/Screenshots/3.png)
...
![Створення нотатки](app/Screenshots/4.png)
...
![Адміністраторська панель](app/Screenshots/5.png)
...
![Список нотаток ADMIN](app/Screenshots/6.png)
